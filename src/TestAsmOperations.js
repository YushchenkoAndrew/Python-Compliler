...
//       this.proc.body.push(`ADD ${dst}, ${src}`);
...
//       console.log(`IMUL EAX, ${src}`);
//       this.proc.body.push(`IMUL EAX, ${src}`);
//       // this.proc.body.push(`MOV ${reg}, ${src}`);
//       // this.regs.available.push(reg);
//       // console.log(`MUL EAX, EDX`);
